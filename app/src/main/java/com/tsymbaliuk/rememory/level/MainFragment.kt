...
class MainFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        gameViewModel.allLevels.observe(viewLifecycleOwner, Observer { allLevels ->
            levelAdapter.updateData(allLevels)
            if (indicator.visibility == View.INVISIBLE && allLevels.isNotEmpty()) {
